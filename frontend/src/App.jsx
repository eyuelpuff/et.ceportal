    ...
    <header className="flex relative justify-between items-center h-15 w-screen  bg-[#37393A] p-6 opacity-100">
      ...
      <div className="w-175  h-15 flex justify-center gap-4">
        <ul className="flex items-center gap-4 ">
          {data.data.nav.nav.map((item) => (
            <li className="text-white hover:text-grey-300 hover:underline">
              {item}
            </li>
          ))}
        </ul>
    ...
    <main>
      ...
      <div className="scroll-smooth w-screen h-200 flex p-8 gap-8 justify-around">
        <div className="flex-1 flex flex-col overflow-hidden">
          <img
            ...
            src="./src/assets/adanech_pic.jpg"
          />
      ...
      <div className="w-screen">
        ...
        <div className=" px-12 flex flex-row justify-center gap-8 h-100 w-screen mx-auto">
          ...
          <div className=" px-4 py-8 border border-black h-90 flex-1 rounded-2xl flex flex-col justify-start">
            ...
            <h1 className="z-0 mt-4 text-xl font-medium">
              Property Tax & Assessement
            </h1>
            <p className="mt-4 text-start">
              Addis Ababa property tax information, payment options, assessment
              records, and related legal documentation.
            </p>
          ...
          <div className=" px-4 py-8 border border-black h-90  flex-1 rounded-2xl flex flex-col justify-start">
            ...
            <p className="mt-4 text-start">
              Stay updated with the latest legal amendments, policy changes, and
              regulatory updates affecting city residents.
            </p>
            <ul className="mt-4 list-inside list-disc">
      ...
      <div className="flex gap-8 mt-10 h-130 w-screen p-8">
        <article className="flex flex-col flex-1 min-w-[200px] rounded-2xl bg-gray-100">
          ...
          <section className="flex-1 flex flex-col p-8">
            ...
            <p className="font-medium text-md">
              Ethiopia with the help of Italy will be hosting the coming UN food
              systems Summit, with Italy In connection with this conference,
              Prime Minister Abiy Ahmed (PhD) received and spoke to heads of
              institutions and leaders who arrived in Addis Ababa.
              <br />
              The Prime Minister received and spoke to the Prime Minister of
              Italy, the President of Somalia, the UN Deputy Secretary-General,
              the Director-General of FAO, the President of IFAD, the UN
              Assistant Secretary-General, and the UNDP Regional Director for
              Africa.
            </p>
            <a className="block underline min-w-20 mt-auto ml-auto" href="#">
              Read more
            </a>
          </section>
        </article>
        <article className="flex flex-col flex-1 relative min-w-[200px] rounded-2xl bg-gray-100">
          ...
          <div className="absolute shadow-[-10px_0_10px_rgba(0,0,0,0.2)] right-0 w-5 h-110 -mr-4 bg-gray-900 opacity-50 hover:opacity-100"></div>
        </article>
      </div>
      <div>
        <h1 className="text-center my-8 text-3xl">
        ...
        <div className="flex p-8 gap-8">
          <div className="p-8 h-100 flex-1 flex flex-col border border-black rounded-2xl">
            ...
            <p className="text-md font-medium text-justify">
              {" "}
              Report criminal activities and hazardous situations to local
              authorities through our secure reporting system. you can call them
              through
            </p>
          ...
          <div className="p-8 h-100 flex-1 flex flex-col border border-black rounded-2xl">
            ...
            <p className="text-md font-medium text-start">
              Access fire department services, report hazardous conditions, and
          ...
          <div className="p-8 h-100 flex-1 flex flex-col border border-black rounded-2xl">
            ...
            <p className="text-md font-medium text-justify">
              Report traffic accidents, road hazards, and access real-time
              traffic incident updates and alerts.
            </p>
            <ul className="list-disc list-inside">
              <li className="">dial 991 or 916</li>
              <li className="">text </li>
    ...
    <footer>
      <div className="grid grid-rows-1 grid-cols-4 h-100 w-screen px-16 gap-4 p-8 border border-black bg-[#1D5793]">
        <div className="p-8 col-span-1 row-span-1 border border-black">
          ...
          <p className="text-medium hover:underline text-white">
            Your comprehensive city administration portal for all municipal
        ...
        <div className="p-8 col-span-1 row-span-1 border border-black">
          ...
          <ul className="space-y-2 list-inside list-none">
            <li className="text-medium hover:underline text-white">
              Public Transportation
            </li>
            <li className="text-medium hover:underline text-white">
              Property Tax
      ...
      <h2 className="text-whte">
        2025 City Administration. All rights reserved.
      </h2>
    </footer>
  );
}

import {
  ...
  QueryClientProvider,
  img
} from "./chunk-WP7OXHNL.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-FNBZHGRZ.js";
import {
  useNpsSurveySettings
} from "./chunk-KIP2OT74.js";
import {
  GuidedTourContext
} from "./chunk-D7NMBJCP.js";
import {
  require_pick
} from "./chunk-REZOHTCL.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-TTBSBOZQ.js";
import {
  useEnterprise
} from "./chunk-QPY6ZNZQ.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-CJQOQ7FQ.js";
import {
  Login
} from "./chunk-RVXRLLW4.js";
import {
  MemoizedInputRenderer
} from "./chunk-MCDSVZI7.js";
import {
  Form
} from "./chunk-SJ7KA2FT.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-T5SCAYKP.js";
import {
  ConfigurationProvider
} from "./chunk-MRF3ZLMV.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-ZEF4I2G4.js";
import {
  require_baseRest
} from "./chunk-INCZXFSB.js";
import {
  HistoryProvider
} from "./chunk-ZXLM6UYO.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-S7WBP6BH.js";
import {
  Layouts
} from "./chunk-XKL5C7MW.js";
import {
  TrackingProvider,
  useTracking
...
} from "./chunk-2JMO32LK.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-L67CSQ3J.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-AXREAQFK.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-7F6ZGWHK.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-3QNWRRF4.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-ETAVQXEP.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-R4C6LUJH.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-A4IEB65G.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-QFRA75YR.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-WLIKORPR.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-MIVNVEVH.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-KK7WJK33.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-LRBT7YQ3.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-2XR73QOW.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-ZPG4YSHO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-5CPCDEN2.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-LVJNO5H4.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-EV6STUH4.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-Z5WHQMYQ.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-6AFA5EZF.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-JGDAZVON.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-WQW2U3DD.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-5UOF2IS4.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-CU6V7JOB.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-M7UELUQH.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-37BEG6AI.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-C64NFKC5.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-OMJJOKFA.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-36OOEX4V.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-VLUDET6A.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-G2JZTNBR.js");
              return {
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-BZFR5A6P.js");
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-DKS44SQQ.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-MMCR2UFS.js");
...
//# sourceMappingURL=chunk-MCBSR63A.js.map

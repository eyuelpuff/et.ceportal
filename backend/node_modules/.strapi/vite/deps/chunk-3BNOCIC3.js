...
import {
  LimitsModal
} from "./chunk-GGBQKAQ5.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-ZSIMDEMA.js";
import {
  getStageColorByHex
} from "./chunk-SNUFEKAR.js";
import {
...
} from "./chunk-TQTCSHPH.js";
import {
  useTypedSelector
} from "./chunk-U5WIUIGQ.js";
import {
  ...
  useGetLocalesQuery
} from "./chunk-3RKUO7NR.js";
import {
  PERMISSIONS as PERMISSIONS5,
  ReleaseActionMenu,
  ReleaseActionOptions,
  pluginId as pluginId4
} from "./chunk-F7YDU5WE.js";
import {
  index
} from "./chunk-HBF56GGJ.js";
import {
  getTimezoneOffset,
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-PKAJB7JT.js";
import {
  useConfig
} from "./chunk-FYWTFE6R.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-I7MV5O3V.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-3NYKWCGI.js";
import {
  buildValidParams,
...
import {
  renderAdmin
} from "./chunk-MCBSR63A.js";
import {
  useLicenseLimits
} from "./chunk-ML2LEAMF.js";
import {
  Table,
  useTable
} from "./chunk-ZHGAJWWH.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-TO6IGN6I.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-RVJH72K7.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-DA5UZOW4.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-4ESBIVEC.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-IX6WC2XK.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-GOTTJ4BP.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-GFFLGKSF.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-GJKASNGW.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-DBBPKIX3.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-BCCO2NKH.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-U5HRSD4D.js");
          return {
...
//# sourceMappingURL=chunk-3BNOCIC3.js.map
